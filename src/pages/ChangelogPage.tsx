...
const patchNotes: PatchNote[] = [
  {
    version: '2.9.3',
    date: '26 Mar 2026',
    title: 'Ultra Upscale V2 — Pipeline Multi-Pass (Ultimate Upscale)',
    emoji: '🔬',
    highlights: [
      'Motor reescrito com pipeline multi-pass inspirado no ComfyUI Ultimate Upscale V5',
      'Pass 1: Upscale estrutural + reconstrução de texturas + face detailing',
      'Pass 2: Polish pass com micro-refinamento (denoise 0.10)',
      'Filosofia de baixa intervenção — preservação máxima da imagem original',
    ],
    changes: [
      {
        icon: <Cpu className="h-4 w-4" />,
        category: 'Pipeline Multi-Pass',
        tag: 'motor',
        items: [
          'Pass 1: Upscale estrutural equivalente a 4xRealWebPhoto + KSampler denoise 0.20',
          'Pass 2: Polish & micro-detail — refinamento final com intervenção mínima',
          'Processamento tile-aware: consistência de detalhes em regiões de 1024×1024',
          'Face Detailing dedicado: detecção e enhancement extra para rostos',
          'Retry inteligente com exponential backoff para 429 e 503',
        ],
      },
      {
        icon: <Zap className="h-4 w-4" />,
        category: 'Qualidade Professional',
        tag: 'melhoria',
        items: [
          'Texturas fotorrealistas: poros, fios de cabelo, trama de tecido, grão de madeira',
          'Limite de intervenção: < 3% desvio de cor, 0% desvio estrutural',
          'Reconstrução de micro-detalhes em nível de LoRA de realismo',
          'Limpeza de artefatos pré-upscale antes da reconstrução',
          'Qualidade alvo: equivalente a Phase One IQ4 150MP nativo',
        ],
      },
      {
        ...
        tag: 'ux',
        items: [
          'Loading mostra etapas do pipeline: "Pass 1: Structural · Pass 2: Polish"',
          'Inspirado em workflow ComfyUI profissional de 16.000+ nodes',
          'Resultado com fidelidade de remaster profissional, não "AI enhancement"',
        ],
      },
    ],
  },
