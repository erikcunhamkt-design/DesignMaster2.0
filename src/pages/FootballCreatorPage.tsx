...
function FootballPreviewPanel({
  ...
  const handleDownload = useCallback(async () => {
    ...
    try {
      ...
      link.href = imageUrl;
      link.download = `football-creator-${Date.now()}.png`;
      link.click();
  ...
  return (
    <div className="flex flex-1 flex-col overflow-hidden bg-background relative">
      {/* Ambient football glow */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute w-[500px] h-[500px] rounded-full -top-60 left-1/4 bg-primary/5 blur-[120px]" />
        <div className="absolute w-[300px] h-[300px] rounded-full -bottom-32 right-1/4 bg-emerald-500/4 blur-[80px]" />
      </div>

      {/* Toolbar (concluido only) */}
        ...
        {state === 'aguardando' && (
          <div className="flex flex-col items-center gap-8 animate-fade-up max-w-[240px] text-center">
            <div className="relative">
              ...
              <div className="absolute -inset-6 rounded-3xl bg-gradient-to-br from-primary/5 to-emerald-500/3 -z-10 animate-breathe" />
            </div>
            <div className="space-y-2">
              ...
              <p className="text-[11px] text-muted-foreground/30 leading-relaxed">
                ...
                <span className="text-primary/60 font-semibold">Gerar Arte ⚽</span>
              </p>
            </div>
            {/* Football style decorators */}
        ...
        {state === 'gerando' && (
          <div className="flex flex-col items-center gap-8 animate-fade-up">
            <div className="relative h-24 w-24">
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-primary/15 to-emerald-500/10 animate-breathe" />
            ...
            <div className="text-center space-y-2">
              <p className="font-display text-base font-semibold tracking-tight text-foreground/60">Gerando arte esportiva…</p>
              <p className="text-[11px] text-muted-foreground/35">IA construindo visual profissional de futebol</p>
            </div>
          ...
          <div className="relative inline-block group" style={{ maxWidth: `${zoom}%`, maxHeight: `${zoom}%` }}>
            ...
            {hasTextOverlay && showOverlay && (
              ...
              >
                ...
                {config.cta && (
                  <div className="mt-1 rounded-full px-5 py-1.5 font-semibold shadow-lg" style={{ fontSize: 'clamp(10px, 2vw, 16px)', backgroundColor: config.primaryTeamColor || '#16a34a', color: '#FFFFFF' }}>
                    {config.cta}
                  </div>
                )}
              </div>
...
export default function FootballCreatorPage() {
  ...
  const handleGenerate = useCallback(async () => {
    ...
    try {
      ...
      // Convert subject photos to base64
      ...
      console.error('Football generation error:', err);
