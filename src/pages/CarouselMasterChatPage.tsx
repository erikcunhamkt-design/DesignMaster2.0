...
export default function CarouselMasterChatPage() {
  ...
  return (
    <div className="flex h-screen w-full flex-col overflow-hidden bg-background">
      <StudioTopbar title="Carrossel Master" showApiKey={true} />
            ...
            {messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full min-h-[60vh] gap-6 animate-fade-up">
                ...
                <div className="text-center space-y-2">
                  <h2 className="text-2xl font-bold font-display text-foreground">Carrossel Master</h2>
                  <p className="text-sm text-muted-foreground max-w-md">
                    Especialista em carrosséis magnéticos e virais para Instagram. Slide a slide, com máxima retenção.
                  </p>
                </div>
            ...
            <div className="max-w-3xl mx-auto flex items-end gap-2">
              ...
              <div className="relative flex-1">
                <Textarea
                  ...
                  placeholder="Descreva o tema do carrossel..."
