...
const SUGGESTIONS = [
  ...
  '🎯 Calendário de conteúdo para uma loja de roupas femininas',
  '🏋️ Monte um calendário para um personal trainer online',
  '💼 Calendário quinzenal para um consultor de negócios digitais',
  '🍕 Calendário de conteúdo para uma pizzaria artesanal',
];
...
export default function CalendarChatPage() {
  ...
  return (
    <div className="flex h-screen w-full flex-col overflow-hidden bg-background">
      <StudioTopbar title="Calendário Master" showApiKey={true} />
            ...
            {messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full min-h-[60vh] gap-6 animate-fade-up">
                ...
                <div className="text-center space-y-2">
                  <h2 className="text-2xl font-bold font-display text-foreground">Calendário Master</h2>
                  <p className="text-sm text-muted-foreground max-w-md">
                    Especialista em calendários estratégicos de conteúdo. Me conte sobre seu negócio e eu monto seu calendário quinzenal.
                  </p>
                </div>
                  ...
                  <div key={i} className={cn('flex gap-3', msg.role === 'user' ? 'justify-end' : 'justify-start')}>
                    ...
                    <div
                      className={cn(
                        ...
                        msg.role === 'user' ? 'bg-primary text-primary-foreground rounded-br-md' : 'bg-card/60 border border-border/20 rounded-bl-md'
                      )}
                    >
                      {msg.role === 'assistant' ? (
